 ...
 * @author petok
 */
public class Jablko implements IObjekt {
    ...
    public Jablko(int konstantaPohybu, int surX, String cesta) throws IOException {
        ...
        try {
            ...
            throw new IOException(ex.getMessage() + " jablko");
        }
    }
    @Override
    public int getSurX() {
